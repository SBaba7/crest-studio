...
export function Login() {
  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center p-4 sm:p-6 selection:bg-purple-500/30 overflow-hidden">
      ...
      {/* Main Login Card with clean white aesthetic and harmonious typography */}
      <div className="w-full max-w-[420px] rounded-[24px] bg-white border border-neutral-200/90 p-7 sm:p-9 shadow-2xl relative z-10">
        {/* Header */}
        <div className="text-center mb-6">
          <h1 className="text-2xl sm:text-[26px] font-semibold text-neutral-900 font-display tracking-tight">
            {isSignUp ? "Create an Account" : "Sign in to Account"}
          </h1>
          <p className="text-sm text-neutral-500 mt-1.5 font-light">
            {isSignUp ? "Get started with the Crest platform." : "Welcome back. Enter your details to continue."}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          <div>
            ...
            <input
              ...
              className="w-full bg-neutral-50/80 hover:bg-neutral-50 border border-neutral-200 focus:border-[#581c87] focus:bg-white focus:ring-2 focus:ring-purple-600/10 rounded-xl px-4 py-3.5 text-sm text-neutral-900 placeholder:text-neutral-400 focus:outline-none transition-all"
            />
          </div>

          <button
            type="submit"
            className="w-full bg-[#581c87] hover:bg-[#6b21a8] active:bg-[#4a1670] text-white font-semibold rounded-xl py-3 text-sm transition-all cursor-pointer shadow-sm flex items-center justify-center gap-2"
          >
            {isSubmitted ? (
              <>
        ...
        <div className="relative my-5 flex items-center justify-center">
          ...
          <span className="bg-white px-3 text-[11px] uppercase tracking-wider text-neutral-400 font-medium absolute">
            or continue with
          </span>
        </div>
        ...
        <div className="space-y-2.5">
          ...
          <button
            ...
            className="w-full bg-white hover:bg-neutral-50 active:bg-neutral-100 border border-neutral-200 rounded-xl py-2.5 px-4 text-sm font-medium text-neutral-700 flex items-center justify-center gap-3 transition-all cursor-pointer shadow-xs"
          >
        ...
        <p className="text-center text-xs text-neutral-500 mt-6 font-light">
          ...
          <button
            ...
            className="text-[#581c87] hover:underline font-semibold cursor-pointer ml-1"
          >
        ...
        {/* Legal Disclaimer */}
        <p className="text-[11px] text-neutral-400 text-center leading-relaxed mt-5 font-light">
